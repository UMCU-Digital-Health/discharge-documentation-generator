...
### Changed
- Changed the GitHub pipelines to also run when doing a PR to a release branch.

## [2.12.0] - 2025-11-12

### Changed
- Changed the storage of data within the development dashboard to a database instead of local files.
- Updated the data_pipeline according to the changes made for the development dashboard


## [2.11.1] - 2025-10-31

### Changed
- Updated prompt for PICU and ORT.
- Generated new batch letters for prompt engineering sessions for PICU and ORT.
...
### Added 
- Added generation time for generated discharge letters (not bulk)
- Added a toggle for dev mode

## [2.7.4] - 2025-09-01

### Changed
- Updated auth.toml file to include new PICU key user. 
