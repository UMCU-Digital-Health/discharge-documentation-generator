...
read -p "What do you want to deploy? Options: 'eval'/1 ; 'api-periodic-acc'/2 ; 'api-periodic-prod'/3  ; 'api-on-demand-acc'/4 ; 'api-on-demand-prod'/5 ; 'admin'/6 - " APPLICATION
