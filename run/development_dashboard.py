...
def display_generated_discharge_doc(
    ...
    post_processing_prompt : str
        The post-processing prompt to refine the generated documentation.
    development_admissions : dict
        The stored patient admissions data.
    ...
    patient_data = query_patient_file(selected_patient_admission, SESSIONMAKER)
    development_admissions_df = pd.DataFrame(development_admissions)

    department, length_of_stay = development_admissions_df.loc[
        development_admissions_df["enc_id"] == int(selected_patient_admission),
